...
5. **Honeypot detection.** Flags profiles with concrete data anomalies (impossible date spans, assessment contradictions) — never penalizes genuinely excellent candidates.
